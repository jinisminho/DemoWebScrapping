...
public class XJCGenerator {
    ...
    private static final String destPackage = "autogenerated.entities." + "audio46.products";
    private static final String xsd = SchemaEnums.AUDIO46_PRODUCTS_SCHEMA.getFileName();
